...
<html>
	...
	<body style="background-color:lightblue">
		...
		<div class="container">
			<br/>
			<h1 style='text-align:center;'>Registrar nuevos datos de cliente. </h1>
			<br/>
			<div class="row">
				<div class="col-xm-2"></div>
				<div class="col-xm-8" style="text-align:center">
					<img src="Imagen/vista_Clientes.jpg" alt="Vista_Clientes" width="400" height="200">
				</div>
				<div class="col-xm-2"></div>
			</div>
			<br>
			...
			<div class="row"></div>
				<form role="form" class="form-horizontal" action="../UIL/manipulacion.php" method="post">
					...
					<div class="form-group has-success has-feedback">
						<div class="col-xm-2"></div>
						<label class="control-label col-sm-4" for="dir">Dirección:</label>
						<div class="col-sm-4">
					...
					<div class="form-group has-success has-feedback">
						<div class="col-xm-2"></div>
						<label class="control-label col-sm-4" for="cd">Ciudad:</label>
						<div class="col-sm-4">
					...
					<center>
					<button type="submit" class="btn btn-success"  name="add_Cliente"><span class="glyphicon glyphicon-ok"></span> Registrar</button>
					</center>
				</form>
			</div>
			<br/>
